...
const Invoice = () => {
  ...
  const [companyName, setCompanyName] = useState("INFINITECH Advertising Corporation");
  const [companyAddress, setCompanyAddress] = useState("Unit 311, Campos Rueda Building, Urban Avenue, Makati City");
  ...
  const totalAmount = items.reduce((sum, item) => sum + (parseFloat(item.purpose) || 0), 0);
      ...
      <div className="flex justify-center items-center py-10">
        <div className="w-full max-w-3xl bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="mt-8">
            <table className="w-full border border-gray-300 text-sm">
              <thead>
                <tr className="bg-gray-200">
                  <th className="border border-gray-300 px-4 py-2 w-3/4 text-left">Particulars</th>
                  <th className="border border-gray-300 px-4 py-2 w-1/4 text-right">Amount</th>
                </tr>
              </thead>
              <tbody>
            ...
            <button id="addRowButton" onClick={addItemRow}
          ...
          <div className="mt-6 text-sm text-gray-700">
            <p>
              <strong>For check payment,</strong> please make check payable to <strong>ABIC REALTY CORPORATION</strong>. <br />
              <strong>For bank deposit,</strong> kindly see below bank account details for reference. Once deposited, send us the deposit slip for payment reference.
            </p>
          </div>
          ...
          <div className="mt-2 text-sm">
            <table className="w-1/2 border border-gray-300 text-left">
              <tbody>
                <tr>
                  <td className="border border-gray-300 px-4 py-2 font-semibold">Bank Details:</td>
                  <td className="border border-gray-300 px-4 py-2">Security Bank Pasay Taft Branch</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 px-4 py-2 font-semibold">Account Name:</td>
                  <td className="border border-gray-300 px-4 py-2">ABIC REALTY CORPORATION</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 px-4 py-2 font-semibold">Account Number:</td>
                  <td className="border border-gray-300 px-4 py-2">0000043381202</td>
                </tr>
              </tbody>
            </table>
          </div>
