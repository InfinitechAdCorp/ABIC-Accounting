        ...
        <CardFooter>
          <div className="w-full bg-[#006FEE] rounded-lg">
            <div className="text-center my-5">
              <h3 className="text-sm text-white md:text-lg font-semibold mb-3">
                Calculation Results
              </h3>
              <div>
                <h3 className="text-white">
                  Monthly Payment:{" "}
                  <strong>{formatNumber(!isNaN(monthly) ? monthly : 0)}</strong>
                </h3>
                <h3 className="text-white">
                  Total Loan Amount:{" "}
                  <strong>{formatNumber(!isNaN(total) ? total : 0)}</strong>
                </h3>
              </div>
            </div>
          </div>
