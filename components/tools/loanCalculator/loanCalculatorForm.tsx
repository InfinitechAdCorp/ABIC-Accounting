...
const LoanCalculatorForm = () => {
  ...
  const exportToPDF = () => {
    ...
    const footerText =
      "This is system-generated This is system-generated This is system-generated This is system-generated This is system-generated";
    const footerY = 180;
    doc.setFontSize(10);
      ...
      <div className="bg-white rounded-lg shadow-lg w-full sm:w-96 p-6 m-7">
        ...
        {monthlyPayment !== null && (
          ...
          >
            ...
            <button
              onClick={exportToPDF}
              className="mt-4 w-full bg-[#006FEE] text-white rounded-lg py-2"
            >
              Export to PDF
            </button>
            <button
